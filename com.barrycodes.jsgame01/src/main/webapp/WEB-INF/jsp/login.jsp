...
<div class="wrapper container">
    <div class="row">
            ...
            <form:form modelAttribute="gameUserVo" cssClass="form-horizontal col-sm-5" action="/login" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-8 col-sm-offset-4">
                        ...
                        <form:button type="submit" value="save" class="btn btn-primary loginSubmit">Login</form:button>
                    </div>
                </div>
            </form:form>
            <div class="col-sm-7">
        ...
        <div class="${errorAlert==null?'hidden':'errorAlert'} col-sm-3" id="errorAlert">
            <div class="alert alert-dismissible alert-danger">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <strong>Oh snap!</strong> Incorrect login/password!
            </div>
        </div>
    </div>
</div>
